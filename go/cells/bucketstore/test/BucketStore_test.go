...
import (
	...
	bucketstore_client "github.com/hiveot/hivekit/go/cells/bucketstore/client"
...
const (
	...
	propDeviceBattery         = "battery"
	propDeviceTitle           = "tile"
	propDeviceSoftwareVersion = "version"
	propEnvTemperature        = "temperature"
	unitPercent               = "%"
)
...
func createTD(id string) *td.TD {
	...
	tdi.Properties[propDeviceSoftwareVersion] = &td.PropertyAffordance{
		DataSchema: td.DataSchema{
			Title:       "Version",
	...
	tdi.Events[propEnvTemperature] = &td.EventAffordance{
		Title:       "Event 1",
...
func startServer(t *testing.T) (bucketstore.IBucketStoreService, func(), error) {
	m, err := bucketstore_service.NewBucketStoreService(storageLocation, testBackendType)
...
func TestWriteRead(t *testing.T) {
	...
	// needs to be tested
	t.Log("sleeping for 4 seconds to have kvstore flush everything in autosave")
