...
const (
	...
	// another service in the chain can retrieve the directory TDD using this action
...
// the DirectoryService cell chain as it converts http requests to RRN messages.
