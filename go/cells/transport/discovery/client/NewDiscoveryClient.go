...
func NewDiscoveryClient(appEnv *api.HiveEnvironment, discoOnStart bool) discovery.IDiscoveryClient {
	cl := clientimpl.NewDiscoveryClientImpl(appEnv, discoOnStart)
	return cl
}
