...
const (
	ThingDiscoveryServerCellType = "thingDiscovery"
)
...
// Actions to serve discovery of a TD provided by a different cell.
// Note: The discovery service triggers on requests with these actions regardless the thingID used.
//
// For example a cell chain with a service or device cell can publish its TD by sending a
...
// This is a service that for publishing the presence of the Thing.
//
// If this is used in a cell chain then the action to write a TD.
//
