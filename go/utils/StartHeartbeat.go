...
//
// This returns a stop function to end the heartbeat loop. If the heartbeat function is running
// then the heartbeat will wait until it completes. If the heartbeat is no longer running then
// the stop function returns immediately.
//
