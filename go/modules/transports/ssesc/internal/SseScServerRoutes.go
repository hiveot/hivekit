...
func (m *SsescTransport) CreateRoutes(ssePath string, r chi.Router) {
	...
	r.Post(ssescapi.PostSseScNotificationPath, m.onHttpNotificationMessage)
	r.Post(ssescapi.PostSseScRequestPath, m.onHttpRequestMessage)
	r.Post(ssescapi.PostSseScResponsePath, m.onHttpResponseMessage)
...
func (m *SsescTransport) DeleteRoutes(ssePath string, r chi.Router) {
	...
	r.Delete(ssescapi.PostSseScResponsePath, m.onHttpResponseMessage)
}
