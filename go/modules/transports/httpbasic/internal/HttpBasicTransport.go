...
// HttpBasicTransport is a transport module for serving the wot http-basic protocol.
...
// client.
func (m *HttpBasicTransport) HandleNotification(notif *msg.NotificationMessage) {
...
func (m *HttpBasicTransport) HandleRequest(
...
func (m *HttpBasicTransport) Start(yamlConfig string) (err error) {
...
func (m *HttpBasicTransport) Stop() {

}

// NewHttpBasicTransport creates a new WoT http-basic protocol binding.
//
...
func NewHttpBasicTransport(httpServer transports.IHttpServer) *HttpBasicTransport {
