...
func (m *HttpBasicTransport) createRoutes() {
...
func (m *HttpBasicTransport) EnableStatic(base string, staticRoot string) error {
	protRoutes := m.httpServer.GetProtectedRoute()
...
func (m *HttpBasicTransport) onHttpAffordanceOperation(w http.ResponseWriter, r *http.Request) {
	var output any
	var handled bool
...
func (m *HttpBasicTransport) onHttpThingOperation(w http.ResponseWriter, r *http.Request) {
	// same same
	m.onHttpAffordanceOperation(w, r)
}

// onHttpPing with http handler returns a pong response
func (m *HttpBasicTransport) onHttpPing(w http.ResponseWriter, r *http.Request) {
