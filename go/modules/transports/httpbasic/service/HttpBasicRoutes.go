...
func (srv *HttBasicServer) handleAffordanceOperation(w http.ResponseWriter, r *http.Request) {
	var output any
	var handled bool
...
func (srv *HttBasicServer) handleThingOperation(w http.ResponseWriter, r *http.Request) {
	// same same
...
func (srv *HttBasicServer) HandleLogin(w http.ResponseWriter, r *http.Request) {
	var reply any
...
func (srv *HttBasicServer) HandleAuthRefresh(w http.ResponseWriter, r *http.Request) {
	var newToken string
	var oldToken string
	rp, err := GetRequestParams(r)
...
func (srv *HttBasicServer) HandleLogout(w http.ResponseWriter, r *http.Request) {
...
func (srv *HttBasicServer) HandlePing(w http.ResponseWriter, r *http.Request) {
