...
// HttpBasicMsgClient is the RRN messaging client for connecting a WoT client to a WoT server over http/2
// using the WoT http-basic protocol profile.
...
type HttpBasicMsgClient struct {
...
func (cc *HttpBasicMsgClient) ConnectWithToken(token string) error {
...
func (cc *HttpBasicMsgClient) Disconnect() {
...
func (cc *HttpBasicMsgClient) GetAppConnectHandler() transports.ConnectionHandler {
	cc.mux.RLock()
...
func (cc *HttpBasicMsgClient) GetAppNotificationHandler() transports.NotificationHandler {
	cc.mux.RLock()
...
func (cc *HttpBasicMsgClient) GetAppRequestHandler() transports.RequestHandler {
	cc.mux.RLock()
...
func (cc *HttpBasicMsgClient) GetAppResponseHandler() transports.ResponseHandler {
	cc.mux.RLock()
...
func (cc *HttpBasicMsgClient) GetConnectionInfo() transports.ConnectionInfo {
	return cc.cinfo
}
...
func (cc *HttpBasicMsgClient) GetDefaultForm(op, thingID, name string) (f *td.Form) {
...
func (cc *HttpBasicMsgClient) GetTlsClient() *http.Client {
	cc.mux.RLock()
...
func (cc *HttpBasicMsgClient) IsConnected() bool {
...
func (cc *HttpBasicMsgClient) Send(
...
func (cc *HttpBasicMsgClient) handleRequestResult() {
...
func (cc *HttpBasicMsgClient) SendRequest(req *msg.RequestMessage) error {
...
func (cc *HttpBasicMsgClient) SendResponse(resp *msg.ResponseMessage) error {
	return errors.New("HttpBasic doesn't support sending async responses")
}

// SendNotification is not supported in http-basic
func (cc *HttpBasicMsgClient) SendNotification(msg *msg.NotificationMessage) error {
...
func (cc *HttpBasicMsgClient) SetBearerToken(token string) error {
	cc.mux.Lock()
...
func (cc *HttpBasicMsgClient) SetConnected(isConnected bool) {
	cc.isConnected.Store(isConnected)
}

// SetConnectHandler set the application handler for connection status updates
func (cc *HttpBasicMsgClient) SetConnectHandler(cb transports.ConnectionHandler) {
	cc.mux.Lock()
...
func (cc *HttpBasicMsgClient) SetNotificationHandler(cb transports.NotificationHandler) {
	cc.mux.Lock()
...
func (cc *HttpBasicMsgClient) SetRequestHandler(cb transports.RequestHandler) {
	cc.mux.Lock()
...
func (cc *HttpBasicMsgClient) SetResponseHandler(cb transports.ResponseHandler) {
	cc.mux.Lock()
	cc.appResponseHandler = cb
	cc.mux.Unlock()
}

// NewHttpBasicRNNClient creates a new instance of the http-basic protocol binding client.
//
...
//	clientCert optional client certificate to connect with, avoiding the need for login.
//	caCert of the server to validate the server or nil to not check the server cert
//	getForm is the handler for return a form for invoking an operation. nil for default
//	timeout for waiting for response. 0 to use the default.
func NewHttpBasicRNNClient(
	baseURL string, clientID string, clientCert *tls.Certificate, caCert *x509.Certificate,
	getForm transports.GetFormHandler, timeout time.Duration) *HttpBasicMsgClient {
