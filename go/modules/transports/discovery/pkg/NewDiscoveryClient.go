...
import (
	...
	internalclient "github.com/hiveot/hivekit/go/modules/transports/discovery/internal/client"
...
func (cl *DiscoveryClient) DownloadTDD(tddURL string, caCert *x509.Certificate) (tddJSON string, err error) {
	...
	httpCl := httptransportpkg.NewHttpTransportClient(parts.Host, caCert, 0)
