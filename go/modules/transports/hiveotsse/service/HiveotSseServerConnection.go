...
func (c *HiveotSseServerConnection) SendRequest(req *msg.RequestMessage) error {
...
func (c *HiveotSseServerConnection) SendResponse(resp *msg.ResponseMessage) error {
	// This simply sends the message as-is
...
func (c *HiveotSseServerConnection) SetNotificationHandler(cb transports.NotificationHandler) {
	if cb == nil {
