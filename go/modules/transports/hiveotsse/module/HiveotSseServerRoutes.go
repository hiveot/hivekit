...
func (m *HiveotSseModule) CreateRoutes(ssePath string, r chi.Router) {
	...
	r.Post(hiveotsse.PostHiveotSseResponsePath, m.onHttpResponseMessage)
...
func (m *HiveotSseModule) DeleteRoutes(ssePath string, r chi.Router) {
	r.Delete(ssePath, m.onHttpSseConnection)
	r.Delete(hiveotsse.PostHiveotSseNotificationPath, m.onHttpNotificationMessage)
	r.Delete(hiveotsse.PostHiveotSseRequestPath, m.onHttpRequestMessage)
	r.Delete(hiveotsse.PostHiveotSseResponsePath, m.onHttpResponseMessage)
}
...
func (m *HiveotSseModule) onHttpNotificationMessage(w http.ResponseWriter, r *http.Request) {
...
func (m *HiveotSseModule) onHttpRequestMessage(w http.ResponseWriter, r *http.Request) {
...
func (m *HiveotSseModule) onHttpResponseMessage(w http.ResponseWriter, r *http.Request) {
...
func (m *HiveotSseModule) onHttpSseConnection(w http.ResponseWriter, r *http.Request) {
