...
type WssServerConnection struct {
	...
	notificationHandlerPtr atomic.Pointer[transports.NotificationHandler]
	...
	messageConverter transports.IMsgConverter
...
func (sc *WssServerConnection) SendRequest(req *msg.RequestMessage) error {
...
func (sc *WssServerConnection) SetNotificationHandler(cb transports.NotificationHandler) {
	if cb == nil {
...
func (sc *WssServerConnection) SetRequestHandler(cb transports.RequestHandler) {
	if cb == nil {
...
func (sc *WssServerConnection) SetResponseHandler(cb transports.ResponseHandler) {
	if cb == nil {
