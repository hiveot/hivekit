...
import (
	...
	"github.com/hiveot/hivekit/go/modules/transports/wotwss"
	converters "github.com/hiveot/hivekit/go/modules/transports/wotwss/api"
)
...
func (srv *WssServer) Serve(w http.ResponseWriter, r *http.Request) {
	...
	if srv.serverConnectHandler != nil {
		srv.serverConnectHandler(true, nil, c)
	}
	if err != nil {
