...
// The DirectoryRestClient is a client for the Directory service using the REST API.
...
type DirectoryRestClient struct {
...
func (cl *DirectoryRestClient) Close() error {
	if cl.tlsClient != nil {
		cl.tlsClient.Close()
	}
	return nil
...
func (cl *DirectoryRestClient) Connect(
...
func (cl *DirectoryRestClient) CreateThing(tdJson string) error {
...
func (cl *DirectoryRestClient) DeleteThing(thingID string) error {
	basePath := cl.directoryBasePath
...
func (cl *DirectoryRestClient) RetrieveAllThings(offset int, limit int) ([]string, error) {
...
func (cl *DirectoryRestClient) RetrieveThing(thingID string) (string, error) {
...
func (cl *DirectoryRestClient) UpdateThing(tdJson string) error {
...
func NewDirectoryRestClient(timeout time.Duration) *DirectoryRestClient {
	if timeout <= 0 {
		timeout = defaultTimeout
	}

	cl := &DirectoryRestClient{
		timeout: timeout,
	}
