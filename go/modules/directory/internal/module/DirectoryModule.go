// package module with the directory server module
package module
...
// DirectoryModuleServer is a module for serving a WoT Thing directory.
...
type DirectoryModuleServer struct {
...
func (m *DirectoryModuleServer) GetAgentInfo(agentID string) (
...
func (m *DirectoryModuleServer) HandleRequest(req *msg.RequestMessage, replyTo msg.ResponseHandler) (err error) {
...
func (m *DirectoryModuleServer) SetTDHooks(
...
func (m *DirectoryModuleServer) Start(_ string) (err error) {
...
func (m *DirectoryModuleServer) Stop() {
...
func NewDirectoryModule(storageRoot string, httpServer transports.IHttpServer) *DirectoryModuleServer {
	...
	var _ directoryapi.IDirectoryModuleServer = m // interface check
