...
func (m *AuthnServer) GetProfile(clientID string) (profile authnapi.ClientProfile, err error) {
	return m.authnStore.GetProfile(clientID)
}

// GetProfile return a list of client profiles
func (m *AuthnServer) GetProfiles() (profiles []authnapi.ClientProfile, err error) {
...
func (m *AuthnServer) UpdateProfile(senderID string, newProfile authnapi.ClientProfile) error {
...
func NewAuthnServer(authnConfig authnapi.AuthnConfig, httpServer transports.IHttpServer) *AuthnServer {
	...
	var _ authnapi.IAuthnServer = m // interface check
	return m
}
