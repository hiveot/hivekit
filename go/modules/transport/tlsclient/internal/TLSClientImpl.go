...
func (cl *TLSClientImpl) CreateRequest(
	ctx context.Context,
...
func (cl *TLSClientImpl) GetClientCertificate() *tls.Certificate {
...
func (cl *TLSClientImpl) GetClientID() string {
	return cl.clientID
}
func (cl *TLSClientImpl) GetConnectionID() string {
	return cl.cid
}
func (cl *TLSClientImpl) GetHostPort() string {
	return cl.hostPort
}

// GetHttpClient returns the native HTTP client
func (cl *TLSClientImpl) GetHttpClient() *http.Client {
	return cl.httpClient
}

// GetHttpClient returns the native HTTP client
func (cl *TLSClientImpl) GetTlsTransport() *http2.Transport {
...
func (cl *TLSClientImpl) PostForm(path string, formData map[string]string) (
	resp []byte, statusCode int, err error) {
...
func (cl *TLSClientImpl) Put(path string, body []byte) (
	resp []byte, statusCode int, err error) {
