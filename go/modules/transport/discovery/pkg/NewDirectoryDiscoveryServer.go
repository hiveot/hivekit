...
// NewDirectoryDiscoveryServer creates a new discovery server module instance.
//
...
func NewDirectoryDiscoveryServer(instanceID string,
	...
	srv := internalserver.NewDirectoryDiscoveryServerImpl(instanceID, httpServer, endpoints)
	return srv
}
...
func NewDirectoryDiscoveryServerFactory(f api.IModuleFactory, md *api.ModuleDefinition) (api.IHiveModule, error) {
