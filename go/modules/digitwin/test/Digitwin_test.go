...
func TestReadDigitwinProperty(t *testing.T) {
	...
	// the digital twin sink will receive the request to read *unknown* property
	...
	co, _, _ := testEnv.NewConsumerClient(userID, authnapi.ClientRoleViewer, nil)
