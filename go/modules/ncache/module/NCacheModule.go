...
import (
	...
	"github.com/hiveot/hivekit/go/modules/ncache"
...
func (m *NCacheModule) GetCacheStatus() ncache.CacheInfo {
	info := ncache.CacheInfo{
...
func NewNCacheModule() *NCacheModule {
	...
	var _ ncache.INCacheModule = m // interface check
	return m
}
