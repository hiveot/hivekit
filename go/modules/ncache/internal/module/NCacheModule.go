...
import (
	...
	ncacheapi "github.com/hiveot/hivekit/go/modules/ncache/api"
	"github.com/hiveot/hivekit/go/msg"
	"github.com/hiveot/hivekit/go/utils"
	"github.com/hiveot/hivekit/go/wot"
)

// NCacheModule is the notification-cache module implementation
// this implements the INCache and IHiveModule interface
type NCacheModule struct {
...
func (m *NCacheModule) GetCacheStatus() ncacheapi.CacheInfo {
	info := ncacheapi.CacheInfo{
...
func (m *NCacheModule) HandleNotification(notif *msg.NotificationMessage) {
...
func (m *NCacheModule) HandleRequest(req *msg.RequestMessage, replyTo msg.ResponseHandler) (err error) {
	var isCached bool
	var value any
	...
	// case wot.OpReadEvent:
	// value, _,isCached = m.ReadEvent(req.ThingID, req.Name)
	case wot.OpReadProperty:
		value = m.ReadProperty(req.ThingID, req.Name)
		isCached = value != nil
...
// func (m *NCacheModule) ReadAllProperties(thingID string) (v any, isCached bool) {
// 	return nil, false
// }

// ReadEvent returns the latest cached event value.
func (m *NCacheModule) ReadEvent(thingID string, name string) (notif *msg.NotificationMessage) {
...
func (m *NCacheModule) ReadProperty(thingID string, name string) (notif *msg.NotificationMessage) {
...
func (m *NCacheModule) ReadMultipleProperties(
...
func (m *NCacheModule) Start(configYaml string) (err error) {
	return err
}

// Stop closes the logging destination.
func (m *NCacheModule) Stop() {
}

// Create a new instance of the value cache module.
func NewNCacheModule() *NCacheModule {

	m := &NCacheModule{
		store: *NewNCacheStore(),
	}

	var _ ncacheapi.INCacheModule = m // interface check
	return m
}
