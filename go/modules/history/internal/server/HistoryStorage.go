...
func (svc *HistoryServer) CreateCursor(clientID string, thingID string, affName string) (cursorKey string, err error) {
...
func (svc *HistoryServer) ReleaseCursor(clientID string, cursorKey string) error {
