...
func (cl *ReadHistoryClient) GetCursor(thingID string, filterOnName string) (
	...
	args := history.GetCursorArgs{
		ThingID:      thingID,
		FilterOnName: filterOnName,
	}
	resp := history.GetCursorResp{}
	err = cl.co.Rpc(wot.OpInvokeAction, cl.dThingID, history.GetCursorMethod, &args, &resp)
...
func (cl *ReadHistoryClient) ReadHistory(thingID string, filterOnName string,
	...
	err = cl.co.Rpc(wot.OpInvokeAction, cl.dThingID, history.ReadHistoryMethod, &args, &resp)
...
func NewReadHistoryClient(co *clients.Consumer) *ReadHistoryClient {
	...
	histCl := ReadHistoryClient{
		co:       co,
		dThingID: td.MakeDigiTwinThingID(agentID, history.ReadHistoryServiceID),
	}
	return &histCl
}
