...
func (svc *ReadHistory) GetCursor(
	senderID string, args history.GetCursorArgs) (*history.GetCursorResp, error) {
...
func (svc *ReadHistory) ReadHistory(
	_ string, args history.ReadHistoryArgs) (resp history.ReadHistoryResp, err error) {
...
func NewReadHistory(bucketStore bucketstore.IBucketStore) (svc *ReadHistory) {
