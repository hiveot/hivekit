...
func (svc *ReadHistory) First(senderID string, args history.CursorArgs) (*history.CursorSingleResp, error) {
	until := time.Now().UTC()
...
func (svc *ReadHistory) Last(senderID string, args history.CursorArgs) (*history.CursorSingleResp, error) {
...
func (svc *ReadHistory) next(
	cursor bucketstore.IBucketCursor, name string, until time.Time) (
...
func (svc *ReadHistory) Next(senderID string, args history.CursorArgs) (*history.CursorSingleResp, error) {
...
func (svc *ReadHistory) nextN(
	cursor bucketstore.IBucketCursor, filterKey string, endTime time.Time, limit int) (
...
func (svc *ReadHistory) NextN(senderID string, args history.CursorNArgs) (*history.CursorNResp, error) {
...
func (svc *ReadHistory) Prev(
	senderID string, args history.CursorArgs) (*history.CursorSingleResp, error) {
...
func (svc *ReadHistory) PrevN(senderID string, args history.CursorNArgs) (*history.CursorNResp, error) {
...
func (svc *ReadHistory) Release(senderID string, args history.CursorReleaseArgs) error {

	return svc.cursorCache.Release(senderID, args.CursorKey)
}

// seek internal function for seeking with a cursor
func (svc *ReadHistory) seek(cursor bucketstore.IBucketCursor, ts time.Time, key string) (
	tm *msg.ThingValue, valid bool) {
	until := time.Now()
...
// This returns an error if the cursor is not found.
func (svc *ReadHistory) Seek(senderID string, args history.CursorSeekArgs) (
	*history.CursorSingleResp, error) {
