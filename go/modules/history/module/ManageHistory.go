...
func (svc *ManageHistory) _FindFirstRule(tv *msg.ThingValue) *history.RetentionRule {
...
func (svc *ManageHistory) _IsRetained(tv *msg.ThingValue) (bool, *history.RetentionRule) {
...
func (svc *ManageHistory) GetRetentionRule(senderID string, args *history.GetRetentionRuleArgs) (resp *history.GetRetentionRuleResp, err error) {

	tv := msg.ThingValue{
		//AgentID: args.AgentID,
		ThingID:        args.ThingID,
		Name:           args.Name,
		AffordanceType: msg.AffordanceType(args.AffordanceType),
	}
	rule := svc._FindFirstRule(&tv)
...
func (svc *ManageHistory) GetRetentionRules(senderID string) (*history.GetRetentionRulesResp, error) {
	resp := &history.GetRetentionRulesResp{Rules: svc.rules}
	return resp, nil
}

// SetRetentionRules updates the retention rules set
func (svc *ManageHistory) SetRetentionRules(senderID string, args *history.SetRetentionRulesArgs) error {
	ruleCount := 0
...
func NewManageHistory(defaultRules history.RetentionRuleSet) *ManageHistory {
	if defaultRules == nil {
