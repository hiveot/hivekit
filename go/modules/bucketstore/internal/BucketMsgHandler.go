...
func (svc *BucketServiceImpl) handleBucketStoreRequest(
...
func (svc *BucketServiceImpl) Cursor(req *msg.RequestMessage) *msg.ResponseMessage {
	var err error
...
func (svc *BucketServiceImpl) Delete(req *msg.RequestMessage) *msg.ResponseMessage {
...
func (svc *BucketServiceImpl) Get(req *msg.RequestMessage) *msg.ResponseMessage {
	var objectKey string
	var raw []byte
	bucket := svc.store.GetBucket(req.SenderID)
	err := utils.Decode(req.Input, &objectKey)
...
func (svc *BucketServiceImpl) GetMultiple(req *msg.RequestMessage) *msg.ResponseMessage {
	var docKeys []string
...
func (svc *BucketServiceImpl) Set(req *msg.RequestMessage) *msg.ResponseMessage {
	bucket := svc.store.GetBucket(req.SenderID)
...
func (svc *BucketServiceImpl) SetMultiple(req *msg.RequestMessage) *msg.ResponseMessage {
	bucket := svc.store.GetBucket(req.SenderID)
