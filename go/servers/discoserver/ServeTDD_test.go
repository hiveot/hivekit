...
func TestDNSSDScan(t *testing.T) {
	...
	records, err := discoclient.DnsSDScan("", time.Second*2, false)
...
func TestDiscover(t *testing.T) {
	...
	records := discoclient.DiscoverTDD(testServiceName, time.Second, false)
...
func TestDiscoViaDomainName(t *testing.T) {
	...
	// Test if it is discovered
	records := discoclient.DiscoverTDD(testServiceName, time.Second, true)
