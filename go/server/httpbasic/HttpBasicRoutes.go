...
import (
	...
	_ "github.com/hiveot/hivekit/go/messaging"
...
func (srv *HttpWoTBasicServer) handleAffordanceOperation(w http.ResponseWriter, r *http.Request) {
	var output any
	var handled bool
...
func (srv *HttpWoTBasicServer) handleThingOperation(w http.ResponseWriter, r *http.Request) {
	// same same
...
func (srv *HttpWoTBasicServer) HandleLogin(w http.ResponseWriter, r *http.Request) {
	var reply any
...
func (srv *HttpWoTBasicServer) HandleAuthRefresh(w http.ResponseWriter, r *http.Request) {
	var newToken string
	var oldToken string
	rp, err := GetRequestParams(r)
...
func (srv *HttpWoTBasicServer) HandleLogout(w http.ResponseWriter, r *http.Request) {
...
func (srv *HttpWoTBasicServer) HandlePing(w http.ResponseWriter, r *http.Request) {
...
func (srv *HttpWoTBasicServer) setupRouting(router chi.Router) http.Handler {
