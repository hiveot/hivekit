...
var transportServer server.IMessageServer
...
func NewTestClient(clientID string) (messaging.IClientConnection, string) {
	...
	cc, err := client.ConnectWithToken(clientID, token, caCert, fullURL, testTimeout)
	if err != nil {
...
// This panics if a client cannot be created
func NewAgent(clientID string) (messaging.IClientConnection, *agent.Agent, string) {
...
) (srv server.IMessageServer, cancelFunc func()) {
