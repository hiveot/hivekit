...
// TestAuthenticator for testing the transport protocol bindings
...
func (d *TestAuthenticator) Logout(clientID string) {
...
func (d *TestAuthenticator) SetAuthServerURI(authServerURI string) {
	d.authServerURI = authServerURI
}

// update the client's password
func (d *TestAuthenticator) SetPassword(clientID, password string) error {
	return nil
}
