...
const (
	...
	ThingNetGatewayLora           = "hiveot:thing:net:gateway:lora"
...
var DeviceClassesMap = map[string]struct {
	...
	ThingDevice:               {Symbol: "", Title: "Device", Description: "Generic device"},
	...
	ThingNetGatewayLora:    {Symbol: "", Title: "LoRaWAN gateway", Description: "Gateway providing access to LoRa devices"},
